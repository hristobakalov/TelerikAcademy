...
class FillAndPrintMatrix
{
    ...
    {
        //first type
        Console.WriteLine("Insert the width of the matrix!");
        ...
        for (int row = 0; row < n; row++)
        {
            for (int col = 0; col < n; col++)
            {
                Console.Write("{0,4} ", matrixTypeOne[col, row]);
            }
            Console.WriteLine();
        }
        ...
        for (int row = 0; row < n; row++)
        {
            for (int col = 0; col < n; col++)
            {
                Console.Write("{0,4} ", matrixSecondType[row, col]);
            }
            Console.WriteLine();
        }
        counter = 1;
        ...
        for (int i = 0; i < n; i++)
        {
            for (int j = 0; j < n; j++)
            {
                Console.Write("{0,4} ", matrixThirdType[i, j]);
            }
            Console.WriteLine();
        }
        Console.WriteLine("\n");
